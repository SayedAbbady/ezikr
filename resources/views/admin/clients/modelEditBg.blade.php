...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form class="mt-3" enctype="multipart/form-data" accept-charset="utf-8" method="POST" id="clientBgEdit">
        <input type="hidden" name="_token" value="{{ csrf_token()}}">
        <div class="modal-body">
          <img src="{{asset('assets/images/clients/'.$clients[0]->cl_background)}}" alt="">
          <div class="form-group input-File-Custom">
            ...
            <input type="file" name="newFile" id="file" class="input-file sliderUpload-main">
              <label for="file" class="btn btn-tertiary js-labelFile">
                ...
                <span class="js-fileName ">{{$clients[0]->cl_background??'Choose a file'}}</span>
              </label>
